...
if __name__ == '__main__':
    ...
    if args.defence == 'krum' or args.defence == 'multi-krum':
        krum_writer = SummaryWriter("../logs/krum/{}_{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr, args.visualize))
        ...
        RLR_writer = SummaryWriter("../logs/RLR/{}_{}_{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr, args.robustLR_threshold, args.visualize))
        if math.isclose(args.malicious, 0) == False:
            ba_writer = SummaryWriter("../logs/BA/{}_{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr, args.robustLR_threshold))
    ...
    if args.heter == "mnist7":
        mnist7_other_writer = SummaryWriter("../logs/mnist7/other/{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr))
        mnist7_7_writer = SummaryWriter("../logs/mnist7/7/{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr))
        mnist7_bar7_writer = SummaryWriter("../logs/mnist7/bar7/{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr))

    if args.loss:
        loss_writer = SummaryWriter("../logs/loss/{}_{}_{}_{}_{}_{}_{}_{}".format(args.dataset, args.attack, args.malicious, args.defence, args.heter, args.alpha, args.lr_b, args.lr))
